...
**Public extract:** 9,060 rows · **Live catalog:** 9,059 domains
...
- `camp.csv` — public CSV extract (9,060 rows)
- `camp.json` — public JSON extract (9,060 rows)
...
| fast.camp         | premium   | $500      | $500          | 82             | 52     | 4      | name.com            |
...
| elite.camp        | available | $11.99    | $77.99        | 90             | 42     | 5      | name.com            |
...
| ----------------------- | ------------------------------------------------ |
| 9,060-row public sample | 9,059 live domains                               |
...
> Unique Domains. *Available .CAMP One-Word Domains*. Version 2026-04-14. Public GitHub extract for the exact Unique Domains search represented by this repository.
